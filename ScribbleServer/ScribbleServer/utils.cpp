...
std::vector<std::string> ScribbleServer::split(const std::string& str, const std::string& delim)
{
...
std::unordered_map<std::string, std::string>  ScribbleServer::parseUrlArgs(const std::string& urlArgs)
{
    if (urlArgs == "") {
        return {};
    }
